...
{
    public class MessageBroadcasterService : BackgroundService
    {
        private readonly ILogger<MessageBroadcasterService> _logger;
        private readonly IHostApplicationLifetime _appLifeTime;
        public MessageBroadcasterService(ILogger<MessageBroadcasterService> logger, IHostApplicationLifetime appLifeTime)
        {
            _logger = logger;
